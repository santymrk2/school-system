package edu.ecep.base_app.shared.bootstrap;
//⚡
...
import edu.ecep.base_app.gestionacademica.infrastructure.persistence.*;
...
import edu.ecep.base_app.shared.domain.enums.*;

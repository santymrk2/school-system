...
export const matriculas = {
  ...
  update: (id: number, body: DTO.MatriculaDTO) => http.put<void>('/api/matriculas/' + id, body),
...
export const solicitudesBaja = {
  ...
  create: (body: DTO.SolicitudBajaAlumnoCreateDTO) => http.post<number>('/api/bajas', body),
};

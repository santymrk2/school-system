...
export const alumnos = {
  ...
  update: (id: number, body: DTO.AlumnoDTO) => http.put<void>('/api/alumnos/' + id, body),
...
export const familiares = {
  ...
  update: (id: number, body: DTO.FamiliarDTO) => http.put<void>('/api/familiares/' + id, body),
...
export const alumnoFamiliares = {
  ...
  update: (id: number, body: DTO.AlumnoFamiliarDTO) => http.put<void>('/api/alumnos-familiares/' + id, body),
